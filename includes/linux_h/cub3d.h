...
/*   Updated: 2021/06/22 16:01:02 by jpillet          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				cub_get_texture_sprite(char *addr, t_sprite *sprt,
					double sprt_y);
...
int				cub_player_lateral_move(t_game *game, double o_s_x,
					double o_s_y);
...
t_bool			cub_set_texture(t_game *game, t_parser *parser, char *path,
					t_img_data *textures);
void			cub_fiat_lux(t_game *game, t_textures *txtrs, int pix_x);
char			cub_the_wall(t_textures *txtrs);
void			cub_render_closest_wall(t_game *game, t_textures *txtrs,
					int pix);
...
t_bool			cub_get_map_line(t_parser *parser, char **line,
					const char *file);
...
t_bool			cub_malloc_map_columns(char **line, char **line_map,
					int *columns);
